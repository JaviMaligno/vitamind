...
export default function ProfileHeroBold({
  ...
  return (
    <section className="relative isolate overflow-hidden rounded-[2rem] sm:rounded-[2.5rem] min-h-[180px] sm:min-h-[220px]">
      ...
      {/* earthrise (same language as the other bold heroes) */}
      <svg
      ...
      >
        <defs>
          <linearGradient id="profile-limb" x1="0" x2="1">
        ...
        <path d="M-80,700 Q600,120 1280,700" fill="none" stroke="url(#profile-limb)" strokeWidth="3" />
        <circle cx="960" cy="230" r="150" fill="none" stroke="white" strokeOpacity="0.06" strokeWidth="1.5" />
        <circle cx="960" cy="230" r="95" fill="url(#profile-sun)" />

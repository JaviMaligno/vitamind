...
/**
 * The "how long in the sun" mother page for `es`: `/cuanto-sol-vitamina-d`.
 *
 ...
 *
 * The name is a literal, not `SUNTIME_PREFIX["es"]`, because it has to agree
 ...
 */
const PREFIX = "cuanto-sol-vitamina-d";

...
/**
 * The today hub for the `fr` sunrise prefix: `/lever-du-soleil/{city}`.
 *
 ...
 *
 * The name is a literal, not `SUN_PREFIX["fr"]`, because it has to agree with

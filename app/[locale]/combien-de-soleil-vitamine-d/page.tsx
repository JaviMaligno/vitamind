...
/**
 * The "how long in the sun" mother page for `fr`: `/combien-de-soleil-vitamine-d`.
 *
 ...
 *
 * The name is a literal, not `SUNTIME_PREFIX["fr"]`, because it has to agree
 ...
 */
const PREFIX = "combien-de-soleil-vitamine-d";

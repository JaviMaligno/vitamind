...
/**
 * The today hub for the `de` sunrise prefix: `/sonnenaufgang/{city}`.
 *
 ...
 *
 * The name is a literal, not `SUN_PREFIX["de"]`, because it has to agree with

...
/**
 * The "how long in the sun" mother page for `lt`: `/kiek-saules-vitaminui-d`.
 *
 ...
 *
 * The name is a literal, not `SUNTIME_PREFIX["lt"]`, because it has to agree
 ...
 */
const PREFIX = "kiek-saules-vitaminui-d";

...
/**
 * The "how long in the sun" mother page for `ru`: `/skolko-solnca-vitamin-d`.
 *
 ...
 *
 * The name is a literal, not `SUNTIME_PREFIX["ru"]`, because it has to agree
 ...
 */
const PREFIX = "skolko-solnca-vitamin-d";
